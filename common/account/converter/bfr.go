...
func ToBfr(accounts []db.DBScheme, args ...string) option.Options {
	var (
		baseConfig = "https://raw.githubusercontent.com/dickymuliafiqri/sing-box-examples/refs/heads/main/BFR/config.json"
		tags       []string
