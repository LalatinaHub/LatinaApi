...
require (
	github.com/LalatinaHub/LatinaBot v0.0.0-20230605094429-81a9bbddd28c
...
replace (
	...
	github.com/sagernet/sing-box => github.com/LalatinaHub/sing-box v0.0.0-20230610021002-4becc054a346
)
