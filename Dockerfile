...
RUN apt-get update
RUN apt install -y tesseract-ocr libtesseract-dev tesseract-ocr-all libleptonica-dev g++ autoconf automake libtool pkg-config git
RUN apt install -y libpng-dev libjpeg62-turbo-dev libtiff5-dev zlib1g-dev libwebpdemux2 libwebp-dev libopenjp2-7-dev libgif-dev libarchive-dev libcurl4-openssl-dev
